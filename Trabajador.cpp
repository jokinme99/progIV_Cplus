...
void Trabajador::imprimir(){
	cout<<"Trabajador "<<this->idTrabajador<<": "<<endl;
	cout<<"Nombre: "<<this->nombreTrabajador<<" DNI: "<<this->dniTrabajador<<endl;
	cout<<"Telefono: "<<this->telefonoTrabajador<<" Sueldo: "<< this->sueldoTrabajador<<endl;
	cout<<endl;
}
